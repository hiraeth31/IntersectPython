...
def Main():
    print("Данные вводятся из консоли (c) или из файла (f)?")
    userAnsw = input()
    if userAnsw == "c":
        firstX, firstY = input("Введите координаты первой точки: ").split()
        point_a = Point(firstX, firstY)
        secondX, secondY = input("Введите координаты первой точки: ").split()
        point_b = Point(secondX, secondY)
        thirdX, thirdY = input("Введите координаты первой точки: ").split()
        point_c = Point(thirdX, thirdY)
        fourthX, fourthY = input("Введите координаты первой точки: ").split()
        point_d = Point(fourthX, fourthY)
